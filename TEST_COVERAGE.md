...
Current gap:
- Focused contracts exist, and the natural-healing/remove-body-part/ShouldRemove medical patch cluster, corpse alert/forbid boundaries, direct zombie corpse creation, and extract/serum filter visibility now have live evidence. Remaining E gaps are infection alert/UI timing, save-load progression during corpse conversion, and proving cure/double-tap/extract/medical UI together as one player workflow.
