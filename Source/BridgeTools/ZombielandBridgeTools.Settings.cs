	...
	public sealed partial class ZombielandBridgeTools
	{
		...
		static object DescribeSettingsGroup(SettingsGroup group)
		{
			...
			return new
			{
				...
				group.spitterThreat,
				group.blobEnabled,
				group.blobSpawnCooldownDays,
				group.blobExpansionIntervalHours,
				group.blobPostFeedPauseHours,
				group.blobMaxCells,
				group.blobFullBenefitRoomCoverage,
				group.blobSeveranceMaturityCoverage,
				group.blobSeveranceMaturityMinCells,
				group.blobSeveranceMaturityMaxCells,
				group.blobSeveranceReserveCoverage,
				group.blobSeveranceReserveMin,
				group.blobSeveranceReserveMax,
				group.blobZombieIgnoreMinBenefit,
				group.blobDecouplingFeedPulsesPerDay,
				group.blobSymbioteMaxSkillBonus,
				group.blobPathCost,
				group.blobCanBreakConstructedWalls,
				blobCoagulantPotency = group.blobCoagulantPotency.ToString(),
