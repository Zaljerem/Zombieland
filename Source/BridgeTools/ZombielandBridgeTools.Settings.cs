	...
	public sealed partial class ZombielandBridgeTools
	{
		...
		static object DescribeSettingsGroup(SettingsGroup group)
		{
			...
			return new
			{
				...
				group.symbiantSeveranceMaturityCoverage,
				group.symbiantSeveranceMaturityMinCells,
				group.symbiantSeveranceMaturityMaxCells,
				group.symbiantSeveranceReserveCoverage,
				group.symbiantSeveranceReserveMin,
				group.symbiantSeveranceReserveMax,
				group.symbiantZombieIgnoreMinBenefit,
				group.symbiantDecouplingFeedPulsesPerDay,
				group.symbiantMaxSkillBonus,
